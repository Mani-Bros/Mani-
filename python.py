...
class TodoListApp:
    def __init__(self, root):
        ...
        self.task_listbox.bind('<Double-Button-1>', self.complete_task)  # Change lambda event to function call
    ...
    def complete_task(self, event=None):  # Change lambda event to accept an optional event parameter
        selected_task_index = self.task_listbox.curselection()
        if selected_task_index:
